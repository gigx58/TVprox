...
def merger_playlist():
    ...
    lista = '#EXTM3U x-tvg-url="https://raw.githubusercontent.com/gigx58/TVprox/refs/heads/main/epg.xml"\n' + lista
                ...
                if valid_events:
                    ...
                    for event in valid_events:
                        ...
                        for channel in event["channels"]:
                            ...
                            m3u8_content += f"https://gigx58-tvprox.hf.space/proxy/m3u?url={channel['stream_url']}&header_user-agent=Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/133.0.0.0 Safari/537.36&header_referer=https://ilovetoplay.xyz/&header_origin=https://ilovetoplay.xyz\n"
        ...
        with open(OUTPUT_FILE, "w", encoding="utf-8") as f:
            ...
            for category, channels in organized_channels.items():
                ...
                for name, url in channels:
                    ...
                    f.write(f"https://gigx58-tvprox.hf.space/proxy/m3u?url={url}\n\n")
